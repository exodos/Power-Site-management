...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('mux_demux_boards.create')}}" class="btn btn-outline-dark mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-gray-dark font-weight-bold">Mux Demux Board</div>
