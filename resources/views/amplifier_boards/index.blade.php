...
{{--                </div>--}}
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('amplifier_boards.create')}}" class="btn btn-outline-dark mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-gray-dark font-weight-bold">Amplifier Boards</div>
