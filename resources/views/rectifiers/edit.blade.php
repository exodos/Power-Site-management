...
@section('content')
    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-header font-weight-bold bg-primary"><h3 class="mb-0">Update Rectifier</h3></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{route('rectifiers.update', isset($rectifiers)?$rectifiers->id:'')}}" method="post">
                    ...
                    <div class="form-group">
                        <label for="id">Rectifier Id</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="rectifiers_capacity"
                               name="rectifiers_capacity" step="0.01">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-success">Update Rectifier</button>
                    </div>
                </form>
            </div>
        </div>
