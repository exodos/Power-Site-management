            ...
            <div class="card-body">
                ...
                <form action="{{route('rectifiers.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="rectifiers_module_model" name="rectifiers_module_model">
                    </div>
                    <div class="form-group">
                        <label for="number_of_rectifiers_model_slots">Number Of Rectifiers Model Slots</label>
                        <input type="number" class="form-control" id="number_of_rectifiers_model_slots" name="number_of_rectifiers_model_slots">
                    </div>
                    <div class="form-group">
                        <label for="rectifiers_module_capacity">Rectifiers Module Capacity</label>
                        <input type="number" class="form-control" id="rectifiers_module_capacity" name="rectifiers_module_capacity" step="0.01">
                    </div>
                    <div class="form-group">
                        <label for="rectifier_module_Qty">Rectifiers Module QTY</label>
                        <input type="number" class="form-control" id="rectifier_module_Qty" name="rectifier_module_Qty">
                    </div>
                    <div class="form-group">
                        <label for="llvd_capacity">LLVD Capacity</label>
                        <input type="number" class="form-control" id="llvd_capacity" name="llvd_capacity" step="0.01">
                    </div>
                    <div class="form-group">
                        <label for="blvd_capacity">BLVD Capacity</label>
                        <input type="number" class="form-control" id="blvd_capacity" name="blvd_capacity" step="0.01">
                    </div>
                    <div class="form-group">
                        <label for="battery_fuess_Qty">Battery Fuess QTY</label>
                        <input type="number" class="form-control" id="battery_fuess_Qty" name="battery_fuess_Qty">
                    </div>
                    <div class="form-group">
                        <label for="power_of_msag_msan_connected_company">Power Of MSAG/MSAN Connected Company</label>
                        <input type="text" class="form-control" id="power_of_msag_msan_connected_company" name="power_of_msag_msan_connected_company">
                    </div>
                    <div class="form-group">
