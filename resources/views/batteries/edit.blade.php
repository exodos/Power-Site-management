...
@section('content')
    ...
    <div class="container">
        <div class="card border-success">
            <div class="card-header font-weight-bold bg-gradient-primary"><h3 class="mb-0">Update Battery</h3></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{route('batteries.update', isset($battery)?$battery->id:'')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="id"
                               name="id" value="{{$battery->id}}">
                    </div>
                    <div class="form-group">
                        <label for="batteries_type">Battery Type</label>
                        <input type="text" class="form-control" id="batteries_type"
                               name="batteries_type" value="{{$battery->batteries_type}}">
                    </div>
                    <div class="form-group">
                        <label for="batteries_model">Battery Model</label>
                        <input type="text" class="form-control" id="batteries_model"
                               name="batteries_model" value="{{$battery->batteries_model}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="battery_holding_time"
                               name="battery_holding_time" value="{{$battery->battery_holding_time}}" step="0.01" min="0.01" max="24.00">
                    </div>
                    <div class="form-group">
                        <label for="commission_date">Commission Date</label>
                        <input type="date" class="form-control" id="commission_date"
                               name="commission_date" value="{{$battery->commission_date}}">
                    </div>
                    <div class="form-group">
                        <label for="lld_number">LLD Number</label>
                        <input type="number" class="form-control" id="lld_number"
                               name="lld_number" value="{{$battery->lld_number}}">
                    </div>
                    <div class="form-group">
