...
@section('content')
    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-header font-weight-bold bg-primary"><h3 class="mb-0">Create Batteries</h3></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{route('batteries.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="number_of_batteries_group" name="number_of_batteries_group">
                    </div>
                    <div class="form-group">
                        <label for="batteries_capacity">Battery Capacity</label>
                        <input type="number" class="form-control" id="batteries_capacity" name="batteries_capacity" step="0.01">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-success">Add Battery</button>
                    </div>
                </form>
            </div>
        </div>
