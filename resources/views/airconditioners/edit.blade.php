...
@section('content')
    ...
    <div class="container">
        <div class="card border-success">
            <div class="card-header font-weight-bold bg-gradient-primary"><h3 class="mb-0">Update Air Conditioners</h3></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{route('airconditioners.update', isset($air)?$air->id:'')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="lld_number"
                               name="lld_number" value="{{$air->lld_number}}">
                    </div>
                    <div class="form-group">
                        <label for="commission_date">Installation Date</label>
                        <input type="date" class="form-control" id="commission_date"
                               name="commission_date" value="{{$air->commission_date}}">
                    </div>
                    <div class="form-group">
