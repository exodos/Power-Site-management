...
@section('content')
    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-header font-weight-bold bg-primary"><h3 class="mb-0">Create Air Conditioners</h3></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{route('airconditioners.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="air_conditioners_model" name="air_conditioners_model">
                    </div>
                    <div class="form-group">
                        <label for="air_conditioners_capacity">Air Conditioner Capacity</label>
                        <input type="number" class="form-control" id="air_conditioners_capacity" name="air_conditioners_capacity" step="0.01">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-success">Add Air Conditioner</button>
                    </div>
                </form>
            </div>
        </div>
