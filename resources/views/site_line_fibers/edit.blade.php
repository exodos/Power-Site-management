...
@section('content')
    ...
    <div class="container">
        <div class="card border-success">
            <div class="card-header font-weight-bold bg-gradient-success"><h3 class="mb-0">Update Line Fiber</h3></div>
            <div class="card-body">
                @if($errors->any())
