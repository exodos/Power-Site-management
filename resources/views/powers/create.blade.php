...
@section('content')
    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-header font-weight-bold bg-primary"><h3 class="mb-0">Create Power</h3></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{route('powers.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="powers_type" name="powers_type">
                    </div>
                    <div class="form-group">
                        <label for="dg_model">Dg Model</label>
                        <input type="text" class="form-control" id="dg_model" name="dg_model">
                    </div>
                    <div class="form-group">
                        <label for="dg_capacity">Dg Capacity</label>
                        <input type="number" class="form-control" id="dg_capacity" name="dg_capacity">
                    </div>
                    <div class="form-group">
                        <label for="fuel_tanker_capacity">Fuel Tanker Capacity</label>
                        <input type="number" class="form-control" id="fuel_tanker_capacity" name="fuel_tanker_capacity" step="0.01">
                    </div>
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-success">Add Power</button>
                    </div>
                </form>
            </div>
        </div>
