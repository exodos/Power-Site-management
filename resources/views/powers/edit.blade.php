...
@section('content')
    ...
    <div class="container">
        <div class="card border-success">
            <div class="card-header font-weight-bold bg-gradient-primary"><h3 class="mb-0">Update Generator</h3></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{route('powers.update', isset($powers)?$powers->id:'')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="generator_foundation_size"
                               ...
                               value="{{$powers->generator_foundation_size}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="starter_battery_type"
                               name="starter_battery_type" value="{{$powers->starter_battery_type}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="dg_commission_date"
                               name="dg_commission_date" value="{{$powers->dg_commission_date}}">
                    </div>
                    <div class="form-group">
                        <label for="dg_lld_number">DG LLD Number</label>
                        <input type="number" class="form-control" id="dg_lld_number"
                               name="dg_lld_number" value="{{$powers->dg_lld_number}}">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-lg mb-3"
                            ...
                            {{--                            @foreach(\Illuminate\Support\Facades\DB::table('powers')->distinct()->orderBy('grid_power_line_voltage_and_transformer_capacity','ASC')->get(['grid_power_line_voltage_and_transformer_capacity']) as $gridPower)--}}
                            {{--                                <option--}}
                            {{--                                    value="{{$gridPower->grid_power_line_voltage_and_transformer_capacity}}">{{$gridPower->grid_power_line_voltage_and_transformer_capacity}}</option>--}}
                            {{--                            @endforeach--}}

                            <option value="15 kV/50 KVA">15 kV/50 KVA</option>
                            <option value="15 KV/100 KVA">15 KV/100 KVA</option>
                            <option value="15 KV/1250 KVA">15 KV/1250 KVA</option>
                            <option value="15 KV/25 KVA">15 KV/25 KVA</option>
                            <option value="15 KV/315 KVA">15 KV/315 KVA</option>
                            <option value="15 KV/400 KVA">15 KV/400 KVA</option>
                            <option value="15 KV/630 KVA">15 KV/630 KVA</option>
                            <option value="15 KV/800 KVA">15 KV/800 KVA</option>
                            <option value="33 kV/50 KVA">33 kV/50 KVA</option>
                            <option value="33 KV/25 KVA">33 KV/25 KVA</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="transformer_installation_date"
                               name="transformer_installation_date" value="{{$powers->transformer_installation_date}}">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-lg mb-3" name="site_id"
                                id="site_id">
                            <option value="none" selected disabled hidden>Please Select</option>
                            @foreach(\Illuminate\Support\Facades\DB::table('sites')->where('ps_configuration','!=','Mains Only')->Where('ps_configuration','!=','Pure Solar')->orderBy('id','ASC')->get() as $sites)
