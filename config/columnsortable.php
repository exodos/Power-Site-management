...
return [
    ...
    */
    'columns' => [
        'alpha' => [
            'rows' => ['description', 'email', 'name', 'slug', 'air_conditioners_type', 'air_conditioners_model', 'functional_type'],
        ...
        'numeric' => [
            'rows' => ['created_at', 'updated_at', 'level', 'id', 'phone_number', 'air_conditioners_capacity', 'LLD_number', 'installation_date', 'site_id'],
