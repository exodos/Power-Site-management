...
class CreateTransmissionMuxDemuxBoardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transmission_mux_demux_boards', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('transmission_mux_demux_boards');
    }
}
