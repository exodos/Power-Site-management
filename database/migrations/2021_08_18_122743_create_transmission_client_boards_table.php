...
class CreateTransmissionClientBoardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transmission_client_boards', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('transmission_client_boards');
    }
}
