...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/site_line_fibers/export', [TransmissionSiteLineFiberController::class, 'export'])->name('site_line_fibers.export');
    ...
    Route::resource('site_line_fibers', TransmissionSiteLineFiberController::class);
